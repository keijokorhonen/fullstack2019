...
describe('find favorite', () => {
    test('when list is empty', () => {
        ...
        expect(listHelper.favoriteBlog([])).toEqual(expectedOutput)
    })
...
describe('find author with most blogs', () => {
    test('when list is empty', () => {
        ...
        expect(listHelper.mostBlogs([])).toEqual(expectedResult)
    })
...
describe('find author with most likes', () => {
    test('when list is empty', () => {
        ...
        expect(listHelper.mostLikes([])).toEqual(expectedResult)
    })
